...
class CheckpointsControllerTest < ActionController::TestCase
  ...
  test "should create checkpoint" do
    assert_difference('Checkpoint.count') do
      post :create, checkpoint: { comment: @checkpoint.comment, completion_date: @checkpoint.completion_date, group_id: @checkpoint.group_id, requirement_id: @checkpoint.requirement_id, user_id: @checkpoint.user_id }
    end
  ...
  test "should update checkpoint" do
    patch :update, id: @checkpoint, checkpoint: { comment: @checkpoint.comment, completion_date: @checkpoint.completion_date, group_id: @checkpoint.group_id, requirement_id: @checkpoint.requirement_id, user_id: @checkpoint.user_id }
    assert_redirected_to checkpoint_path(assigns(:checkpoint))
  end
