...
ActiveRecord::Schema.define(version: 20170506003314) do
  ...
  add_index "checkpoints", ["group_id"], name: "index_checkpoints_on_group_id"
  add_index "checkpoints", ["requirement_id"], name: "index_checkpoints_on_requirement_id"
  add_index "checkpoints", ["user_id"], name: "index_checkpoints_on_user_id"
